...
int main()
{
    ...
    // -------------------------
    Shader shader("res/shader/cascadedShadowMapping/shader.vs", "res/shader/cascadedShadowMapping/shader.fs");
    Shader simpleDepthShader("res/shader/cascadedShadowMapping/depthShader.vs", "res/shader/cascadedShadowMapping/depthShader.fs", "res/shader/cascadedShadowMapping/depthShader.gs");
    Shader debugDepthQuad("res/shader/cascadedShadowMapping/debugQuad.vs", "res/shader/cascadedShadowMapping/debugQuadDepth.fs");
    Shader debugCascadeShader("res/shader/cascadedShadowMapping/debugCascade.vs", "res/shader/cascadedShadowMapping/debugCascade.fs");
    ...
    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("res/texture/learnopengl/wood.png");
