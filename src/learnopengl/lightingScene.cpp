...
float pitch =  0.0f;
float lastX = 400, lastY = 300; // the last position of mouse
float fov   =  45.0f;
...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("res/shader/lightingScene/shaderL.vs","res/shader/lightingScene/shaderL.fs");
    Shader lightSourceShader("res/shader/lightingScene/lightSource.vs","res/shader/lightingScene/lightSource.fs");
    ...
    // -----------------------------------------------------------------------------
    unsigned int diffuseMap = loadTexture("res/texture/learnopengl/container2.png");
    unsigned int specularMap = loadTexture("res/texture/learnopengl/container2_specular.png");
